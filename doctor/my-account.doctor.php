    ...
    <div class="container">
        ...
        <div class="ddd">
            ...
            <table class="table table-striped table-dark">
                ...
                <?php
                $s = " SELECT studentId, supervisorId FROM training WHERE doctorId = '$id'";
        ...
        <div class="ddd">
            ...
            <table class="table table-striped table-dark">
                ...
                <?php
                $s = " SELECT DISTINCT supervisorId FROM training WHERE doctorId = '$id'";
                $r = mysqli_query($conn, $s);
                while ($row = mysqli_fetch_assoc($r)){
                    $supervisorId = $row["supervisorId"];
                    $sql = " SELECT id, fname, lname, email, phone FROM users WHERE id = '$supervisorId' ";
                    $result = mysqli_query($conn, $sql);
                      if(mysqli_num_rows($result) > 0){
                         while($rr = mysqli_fetch_assoc($result)){  
                     ?> 
